<?php if (!$temp) echo '<h3 class="no-margin-top">Đánh giá sách</h3>' ?>
<form class="bootstrap-validator-form new-review <?php if (!$temp) echo 'col-lg-9 no-padding-left' ?>" action="<?php echo MAIN_URL ?>/review?do=new">
...
<div class="<?php if (!$temp) echo 'col-lg-3 no-padding-right' ?> feed-rv-book">
	<?php if (isset($bIn)) { ?>
...
<?php if ($temp == 'feed') echo '<script src="'.JS.'/review/new.js"></script>' ?>
