<div class="feed-one-item feed-item-review">
	...
	<div class="feed-content col-lg-11 no-padding feed-wr">
		<div class="box box-write feed-main col-lg-8 feed-wr-main">
			<div class="box-header feed-main-head feed-wr-head">
				<a href="#">Tu Nguyen</a> đã thêm 1 <a href="#">chương</a> mới vào <a href="#">HTML5 for Web designers</a>
			</div>
...
Common points that both book reviews and book reports share are presented below. The last point, Critical Comments, is intended only for those writing book reviews.
			...
			<div class="box-footer stat feed-sta">
				<div class="feed-ratings stat-one col-lg-5 no-padding">
					...
					<span class="gensmall">(5 ratings)</span>
				</div>
			...
			<div class="box-footer box-comments">
				<div class="box-comment">
					<div class="box-comment-left">
						...
						<div class="coins-plus" title="Review của Maria Gonzales đã cộng thêm cho Tu Nguyen 5 điểm">
				...
				<div class="box-comment">
					<div class="box-comment-left">
						...
						<div class="coins-plus" title="Review của Luna Stark đã cộng thêm cho Tu Nguyen 5 điểm">
							<span class="text-success">+5</span>
						</div>
					</div>
					<div class="comment-text">
