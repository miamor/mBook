<div class="feed-one-item feed-item-review">
	<div class="feed-user-info col-lg-1 no-padding centered">
		<a href="#" data-online="1">
			<img class="feed-user-avt img-circle" src="http://localhost/mRoom/data/img/13.jpg"/>
		</a>
	</div>
	<div class="feed-content col-lg-11 no-padding feed-ask">
		<div class="box box-ask feed-main col-lg-8 feed-ask-main">
			<div class="box-header feed-main-head feed-ask-head">
				<a href="#">NXB 2</a> muốn hỏi ý kiến bạn về việc <a href="#">Xuất bản cuốn sách [Tên sách]</a>
			</div>
			<div class="box-body feed-main-content feed-ask-content">
...
Common points that both book reviews and book reports share are presented below. The last point, Critical Comments, is intended only for those writing book reviews.
			...
			<div class="box-footer stat feed-sta">
				<div class="feed-ratings stat-one col-lg-6 no-padding">
					<strong class="text-warning">3.5</strong>
					...
					<span class="gensmall">(5 opinions)</span>
				</div>
			...
			<div class="box-footer box-comments">
				...
				<div class="box-comment">
					...
					<div class="comment-text">
						...
						Absolutely agree!!! I've been waiting for this for so longgg! Really hope it'll be published for real!
					</div><!-- /.comment-text -->
				</div><!-- /.box-comment -->
			</div><!-- /.box-footer -->

		</div>
		<div class="col-lg-4 no-padding-right feed-ask-book">
