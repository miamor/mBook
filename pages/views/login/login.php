...
a.btn:not(.login-button):not(.idpicos){max-height:39px!important;padding:10px 12px 9px!important;*line-height:20px!important}
...
<div class="col-lg-6">
	<div class="alerts alert-warning no-margin">We highly recommend you use <b>Login with social network</b> form to log in, since we're currently working on <span class="italic">friends</span> section on mAstro, therefore, friends list will only be extracted from your Facebook account, which means you must <a>login with Facebook</a> to have friends list updated.</div>

<form action="<?php echo MAIN_URL ?>/login?do=login_social" class="login-social">
<div class="social-login" id="idps">
	<h3 class="bor">Login with social network</h3>
	<div class="col-lg-12">
<!--		<a idp="facebook" id="login-facebook" href="?do=login&type=fb" class="btn btn-facebook idpicos"><i class="fa fa-facebook"></i></a>  -->
		<a href="?do=login&type=fb" idp="facebook" id="login-facebook" class="btn btn-block btn-social btn-facebook idpicos">
