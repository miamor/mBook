...
define('MAIN_PATH', './');
define('HOST_URL', 'https://sharemyreading.000webhostapp.com'.$__pattern);
...
class Config {
	...
	private $db_name = "id3459474_mbook";
	private $username = "id3459474_mbook";
	private $password = "westlife297";
	private $port = "3306";
	protected $conn;
	public $u;
	public $me;
